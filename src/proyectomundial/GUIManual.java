...
public class GUIManual extends JFrame {
    ...
    private JPanel jPanelMenuTable;
    private JLabel btnTable;
    ...
    private void initComponents() {
        ...
        // Pinta la opción de Menú de la Tabla
        pintarMenuTable();
    ...
    private void pintarMenuTable() {
        jLabelTop.setText("Tabla");
        btnTable.setIcon(new ImageIcon(getClass().getResource("/resources/icons/dashboard_resultados.png")));
        btnTable.setText("Tabla");
        btnTable.setForeground(new java.awt.Color(255, 255, 255));
        
        JLabel vacioDashboardResultados = new JLabel();
        jPanelMenuTable.setBackground(new java.awt.Color(17, 41, 63));
        jPanelMenuTable.setPreferredSize((new java.awt.Dimension(220, 35)));
        jPanelMenuTable.setLayout(new BorderLayout(15, 0));
        jPanelMenuTable.add(vacioDashboardResultados, BorderLayout.WEST);
        jPanelMenuTable.add(btnTable, BorderLayout.CENTER);
        jPanelMenu.add(jPanelMenuTable);
    ...
    private void accionTabla() {
        ...
        JTable table = new JTable(tabla, columnNames);
